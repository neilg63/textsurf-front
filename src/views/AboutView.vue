...
<ol>
  ...
  <li>Some sites may still return incorrect text encoding and cannot be parsed. Modern sites should use utf-8 or utf-16, but many choose to use earlier standards that fool our http response handler. In some cases you may see odd diamond characters with question marks.</li>
</ol>
